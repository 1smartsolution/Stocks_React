...
const CompanyDetails = props => {
  ...
  if ((companyData.av !== undefined) && (companyData.av["Global Quote"] !== undefined) && (companyData.tmx !== undefined) && (typeof(companyData.tmx.results) == 'object') && (companyData.tmx.results.size !== 0))
  {
    const marks = [
      {
